    ...
    <div className="space-y-4 w-full">
      {selectedMessage ? (
        <div className="bg-white p-6 rounded-md shadow-md max-w-2xl mx-auto">
          ...
          <p className="text-secondary-dark-gray my-4">
            {selectedMessage.body}
          </p>
          <p className="text-sm color-secondary-dark-gray">
            Sent by: {selectedMessage.from} at{" "}
        ...
        messages.map((msg) => (
          <div
            ...
            className="flex items-center bg-gray-100 rounded-md py-4 px-4 w-full max-w-2xl mx-auto"
          >
            <div className="mr-4">
