        ...
        >
          ...
          <div className="bg-white rounded-xl shadow-xl text-black p-6 border border-gray-100 relative overflow-hidden transition-all duration-300 hover:shadow-2xl">
            ...
            <div className="mb-8 pb-6 border-b border-gray-100">
              <h2 className="text-xl font-semibold mb-3 text-primary-black">
                {tenant}
              </h2>
              ...
              <div className="flex justify-center mb-6">
                <div className="grid grid-cols-4 gap-3">
                  {splitCode.map((digit, index) => (
                    <div
                      key={`${digit}-${index}`}
                      className={`w-16 h-16 flex items-center justify-center border border-gray-200 rounded-lg bg-gray-50 shadow-sm transform transition-all duration-300 ${
                        mounted
                          ? `translate-y-0 opacity-100 delay-${index * 100}`
                          : "translate-y-4 opacity-0"
                      } hover:scale-105 hover:shadow-md hover:border-primary-green/30`}
                    >
            ...
            <div className="flex justify-center space-x-4">
              ...
              <a
                href={mailtoLink}
                className="flex items-center px-5 py-3 bg-secondary-blue hover:drop-shadow-md  text-white rounded-lg transition-all duration-300 hover:shadow-md hover:translate-y-[-2px]"
              >
          ...
          <div className="mt-10 flex justify-center">
            <Link
              href="/passkey"
              className="px-6 py-3 bg-primary-green text-alternate-green hover:text-white rounded-lg font-medium transition-all duration-300 inline-flex items-center hover:shadow-lg hover:translate-y-[-2px] group"
            >
